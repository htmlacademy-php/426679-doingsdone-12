<div class="content">
    ...
    <main class="content__main">
        ...
        <form class="form" action="" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form__row">
                <?= !empty($errors['project']) ? '<p class="form__message">' : '' ?>
            ...
            <div class="form__row">
                ...
                <?= isset($errors['date']) ? 'form__input--error' : ''; ?>" type="text" name="date" id="date" value="
                <?= isset($_POST['date']) ? $_POST['date'] : '' ?>" placeholder="Введите дату в формате ГГГГ-ММ-ДД">
            </div>
